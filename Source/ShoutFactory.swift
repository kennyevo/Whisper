...
open class ShoutView: UIView {
    ...
    public struct Dimensions {
        ...
        public static var leftPadding: CGFloat = 0
        public static var rightPadding: CGFloat = 0
    ...
    public func setupFrames() {
        internalHeight = (UIApplication.shared.isStatusBarHidden ? 55 : 65) - Dimensions.bottomPadding
        
        let totalWidth = UIScreen.main.bounds.width - (Dimensions.leftPadding + Dimensions.rightPadding)
        let offset: CGFloat = (UIApplication.shared.isStatusBarHidden ? 2.5 : 5) + Dimensions.topPadding
        ...
        frame = CGRect(x: Dimensions.leftPadding, y: safeYCoordinate + Dimensions.topPadding,
    ...
    open override var frame: CGRect {
        didSet {
            backgroundView.frame = CGRect(x: 0, y: safeYCoordinate + Dimensions.topPadding,
